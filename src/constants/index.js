...
export const SET_ASIDE_DOMINFO = 'SET_ASIDE_DOMINFO';
export const SET_NAVIGATION_DOMINFO = 'SET_NAVIGATION_DOMINFO';
export const SET_SKILLS_DOMINFO = 'SET_SKILLS_DOMINFO';
